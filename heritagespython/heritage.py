...
# 4 immeubles
immeuble1 = Immeuble("26 rue de la bab", 3, 3)
immeuble2 = Immeuble("28 rue de la bab", 5, 6)
immeuble3 = Immeuble("53 rue elios mitterand", 2, 2)
immeuble5 = Immeuble("120 rue pleiades", 8, 4)

print(immeuble1.get_adresse())

# 2 supermarché
supermarche1 = Supermarche("27 rue de la bab", 1, 12)
supermarche2 = Supermarche("119 rue pleiades", 4, 25)

print(supermarche1.get_nb_rayons())

# 1 banque
banque = Banque("53 rue elios mitterand", 25, 3, "BabBanque")

print(banque.get_nom())
